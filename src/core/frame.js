...
var Frame = /** @class */ (function () {
    ...
    Frame.prototype.waitFor = function (selector, options) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.frame.waitFor(selector)];
                    case 1:
                        _b.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, (_a = this.frame).waitFor.apply(_a, __spreadArrays([selector, options], args))];
                    case 3:
                        _b.sent();
                        _b.label = 4;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.frame.$(selector)];
    ...
    Frame.prototype.$$ = function (selector) {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.frame.$$(selector)];
                    case 1:
                        elements = _a.sent();
